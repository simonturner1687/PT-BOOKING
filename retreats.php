<!DOCTYPE html>
<?php include "view/v_public_retreat.php"; ?>
		...
		<section id="content">
			<div class="content-wrap">
				<div class="row clearfix">
						<div class="col-md-4 col-md-offset-1 fancy-title title-bottom-border" style="padding-left: 27px;">
							<h1>FITNESS RETREATS</h1>
						</div>
				</div>
				<?php
					$retreats = display_retreats(); 
					echo $retreats;
				?>
