...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Payment Accepted| Scott Jose Fitness | London</title>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div id="section-pricing" class="heading-block title-center page-section">
						...
						<span>&nbsp;</span>
						<p>Each package is completely tailored to your demands and goals. You'll shortly receive a confirmation email, you will then be contacted by Scott Jose Fitness within 48 hours to start your package and the results will commence.</p>
					</div>
