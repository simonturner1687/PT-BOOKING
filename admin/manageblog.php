...
<div class="bodywrapper">
    ...
    <div class="header">
    	<ul class="headermenu">
            ...
            <li><a href="retreat/manageretreat.php"><span class="icon icon-pencil" aria-hidden="true"></span>Manage Retreats</a></li>
            <?php 
                session_start();
    ...
    <div class="vernav">
    	<ul>
            <li><a href="blog/newpost.php">Create New Post</a></li>
            <li class="current"><a href="manageblog.php" class="editor">All Posts</a></li>
            <li><a href="blog/pub_posts.php">Published Posts</a></li>
            <li><a href="blog/draft_posts.php">Draft Posts</a></li>
            <li><a href="blog/trash_posts.php">Trash</a></li>
        </ul>
    ...
    <tbody>
        <tr>
            ...
            <td class="actions aligncenter">
                <a href="edit_post.php?id='.$blogArray["id"].'">Edit</a> <a href="../../html/blog-single.php?title='.$title.'">View</a> <a href="trash.php?id='.$blogArray["id"].'" class="delete">Delete</a>
            </td>
        </tr>';
    }
}
